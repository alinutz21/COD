...
public class DreaptaNationala extends LinearOpMode {
        ...
        Actions.runBlocking(
                new ParallelAction(
                        ...
                        new SequentialAction(
                                ...
                                drive.actionBuilder(new Pose2d(30,14,Math.toRadians(125)))
                                        .strafeToSplineHeading(new Vector2d(30,-0.5),Math.toRadians(265))
...
//                                        .build(),
                                ...
                                new ParallelAction(
                                        ...
                                        drive.actionBuilder(new Pose2d(30,-0.5,Math.toRadians(265)))
...
//                                        .build(),
                                ...
                                drive.actionBuilder(new Pose2d(-7,39,Math.toRadians(90)))
                                        .strafeToSplineHeading(new Vector2d(30,-1.5),Math.toRadians(270))
                                        .waitSeconds(0.1)
                                        .build(),
...
//                                        .build(),
                                ...
                                new ParallelAction(
                                        ...
                                        drive.actionBuilder(new Pose2d(30,-1.5,Math.toRadians(270)))
